...
L["Show Festival Quests"] = "Показать праздничные задания"
L["If selected, quests related to WoW festive seasons will be displayed on the map"] = "Если отмечено, задания, связанные с праздничными сезонами WoW, будут отображаться на карте."
